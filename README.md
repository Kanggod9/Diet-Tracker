...
Diet Tracker is a local-first Android food and drink journal built with Kotlin and Jetpack Compose. Version 1.2.0 targets Android 16 / API 36 and supports Android 8.0 / API 26 and later.

## What is included

- A turquoise health-style Logs dashboard with a collapsible week/month calendar, food score, swipeable nutrient tiles, target-exceeded coloring, and tap-through nutrient history.
...
- A Target section with framed US, EU, and Singapore nutrient references, editable custom values, and D/W/M/3M/Y intake histograms.
- Explicit Health Connect permission/import review plus foreground automatic create, replace, and delete synchronization for app-created logs. No scheduler or background service is included.
- Collapsible meal-category Journal groups and coverage-aware guidance on Logs.
